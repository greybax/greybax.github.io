...
Most interesting thing that I developed this game without having real Vision Pro device! I've used only Simulator to test it. Later I found interesting tool which can help to debug code better without having real device  (but I still didn't have a chance to use it).


I did the following steps (p.s. I've used just the official website and sent requests via browser without any APIs or internal code-editor extensions):

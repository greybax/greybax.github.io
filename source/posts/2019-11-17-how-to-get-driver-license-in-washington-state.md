...
Думаю, начать нужно с того, что в Америке аналогом паспорта служит так называмый ID. Это маленькая карточка размером как обычные права в РФ и выдается она местным DOL ([Department of Licensing](https://www.dol.wa.gov/)). DOL с вас возьмет за это 89$. ID же является и правами если вы сдали экзамены по вождению.
